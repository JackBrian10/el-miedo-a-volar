    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{
            textShadow:
              "0 2px 20px rgba(0,0,0,0.8), 0 0 60px rgba(255,150,50,0.3)",
          }}
          variants={itemVariants}
        >
          El miedo a volar
        ...
        <motion.a
          ...
          className="text-white/50 text-lg tracking-widest drop-shadow-md hover:text-white/80 transition-colors duration-200"
          variants={itemVariants}
        >
          @elmiedoavolar
        </motion.a>
